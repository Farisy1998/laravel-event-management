...
@section('content')
  ...
  <div class="carousel-inner">
    <div class="carousel-item active">
      <img src="https://excellence.qa/wp-content/uploads/2018/06/events-03.jpg" class="d-block w-100" alt="...">
    </div>
    </div>
</div>
<br>
...
<div class="container">
    <div class="row">
        ...
        <div class="col col-12 col-sm-8 col-md-8 col-lg-8">
            <center><font><h3>Our mission is to ensure that every guest has a wonderful event experience</h3></font></center>
            <hr>
        </div>
        <div class="col col-12 col-sm-2 col-md-2 col-lg-2"></div>
    </div>
    ...
    <div class="row">
        <div class="col col-12 col-sm-4 col-md-4 col-lg-4">
            <center><font><h5>Standardization</h5></font></center>
            <hr>
            <font color="gray">We promises to provide the same awesome experience to all customers across all its venues</font>
        </div>
        <div class="col col-12 col-sm-4 col-md-4 col-lg-4">
            <center><font><h5>Professional Venue Managers</h5></font></center>
            <hr>
            <font color="gray">Venue managers with final authority to give the deal, ensure that customers gets all the information about venues in one go</font>
        </div>
        <div class="col col-12 col-sm-4 col-md-4 col-lg-4">
