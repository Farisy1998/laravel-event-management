      ...
      <div class="row">
        <div class=" col col-12 col-sm-4 col-md-4 col-lg-4">
          <div class="card" style="width: 18rem;">
            <img src="https://sainloevents.co.uk/wp-content/uploads/2015/11/venue-image_web.jpg" height="190px"  class="card-img-top" alt="...">
            <div class="card-body">
              <h5 class="card-title"><a href="/venues">Venues</a></h5>
              <p class="card-text">Banquet Halls and Fully Managed Venues</p>
            </div>
          </div>
        </div>
        <div class="col col-12 col-sm-4 col-md-4 col-lg-4">
